...
<body id="top">
  ...
  <p>
    <ol>
      ...
      <li><a href="<%=request.getContextPath()%>/vocabulary-test.jsp?dictionary=YOUDAO">vocabulary test (Chinese)</a></li>
      <li><a href="<%=request.getContextPath()%>/vocabulary-test.jsp?dictionary=WEBSTER">vocabulary test (English)</a></li>
    <%
      if(user != null){
    %>
