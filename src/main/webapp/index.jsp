...
<body id="top">
  ...
  <p>
    <ol>
      ...
      <li><a href='<%=request.getContextPath()+"/aid-reading/book-aid-reading.jsp?words_type=CET4&dict=ICIBA&book=/it/java/Java%208%20in%20Action%20Lambdas,%20Streams%20and%20Functional-style%20Programming.txt&column=6"%>'>书籍辅助阅读</a></li>
      <li><a href='<%=request.getContextPath()+"/aid-reading/book-aid-reading-detail.jsp?book=/it/java/Java%208%20in%20Action%20Lambdas,%20Streams%20and%20Functional-style%20Programming.txt&word=functional&dict=ICIBA&pageSize=192"%>'>搜索单词对应书籍原文</a></li>
      ...
      <li><a href='<%=request.getContextPath()+"/root-affix/prefix-rule.jsp?prefixes=anti,counter,de,dis,il,im,in,ir,mis,non,un&dict=ICIBA&words_type=CET4&strict=Y&column=6"%>'>前缀规则</a></li>
      <li><a href='<%=request.getContextPath()+"/root-affix/dynamic-prefix-rule.jsp?prefixes=m-imm&dict=ICIBA&words_type=SYLLABUS"%>'>动态前缀规则</a></li>
