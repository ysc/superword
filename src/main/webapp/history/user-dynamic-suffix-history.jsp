...
<%
    ...
    htmlFragment.append("<tr><th>No.</th><th>Dynamic Suffix</th><th>Time</th></tr>");
    int i = 1;
...
<html>
<head>
    <title>dynamic suffix analysis record</title>
...
<h3>user <%=displayName%> dynamic suffix analysis record</h3>
<%=htmlFragment%>
