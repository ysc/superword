...
public class WordClassifierForYouDao {
    private WordClassifierForYouDao(){}

    private static final Logger LOGGER = LoggerFactory.getLogger(WordClassifierForYouDao.class);
    private static final String YOUDAO = WordLinker.YOUDAO;
    private static final String TYPE_CSS_PATH = "span.via.rank";
    private static final String UNFOUND_CSS_PATH = "div.error-typo h4";
    ...
    public static void parseZip(String zipFile){
        ...
        try (FileSystem fs = FileSystems.newFileSystem(Paths.get(zipFile), WordClassifierForYouDao.class.getClassLoader())) {
    ...
    public static String getContent(String word) {
        String url = YOUDAO + word + "&renovate=" + (new Random(System.currentTimeMillis()).nextInt(899999)+100000);
